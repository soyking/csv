...
func ExampleMarshal(t *testing.T) {
	type TypeB struct {
	...
	// output:
	// aa,aaa,bb,bbb,bbbb,cc,ccc,cccc,dd,DDD,ee,eee,eeee,ss,ii,ss,ii,string,int
	// def,字符串,男,女,整数,1.1,woman,浮点数,不是呢,true,男,0,短整数,def,is2,def,is2,fun,is 123
}
